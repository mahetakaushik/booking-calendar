...
const CalendarNavigation: React.FC<CalendarNavigationProps> = ({
  ...
  return (
    <div className="calendar-navigation">
      <button onClick={onPrevMonth} className="nav-btn" title="Previous Month">
        <svg
          width="20px"
          height="20px"
          viewBox="0 0 24 24"
      ...
      <div className="month-header">
        <h3>{monthYear.toUpperCase()}</h3>
      </div>
      <button onClick={onNextMonth} className="nav-btn" title="Next Month">
        <svg
          width="20px"
          height="20px"
          viewBox="0 0 24 24"
